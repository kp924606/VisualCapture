...
namespace VisualCaptureApp.Function
{
    public class FScreenshotFullScreen
    {
        ...
        /// 閃光動畫效果,指定範圍
        /// </summary>
        public static void TriggerFlashEffectAsyncByRange(double x, double y, double width, double height)
        {
            try
            {
                System.Windows.Application.Current.Dispatcher.BeginInvoke((Action)(() =>
                {
                    ...
                    var flashWindow = new Window
                    {
                        ...
                        ResizeMode = ResizeMode.NoResize,
                        ShowInTaskbar = false,
                        Background = new SolidColorBrush(System.Windows.Media.Color.FromArgb(128, 128, 222, 128)),
                        //Background = System.Windows.Media.Brushes.Transparent,
                        AllowsTransparency = true, // 允許透明
                        Topmost = true,
                        Left = x,
        ...
        /// 閃光動畫效果
        /// </summary>
        public static void TriggerFlashEffect(byte a, byte r, byte g, byte b, double time)
        {
            try
            {
                // 計算所有螢幕範圍
                ...
                var flashWindow = new Window
                {
                    ...
                    ResizeMode = ResizeMode.NoResize,
                    ShowInTaskbar = false,
                    Background = new SolidColorBrush(System.Windows.Media.Color.FromArgb(a, r, g, b)),
                    //Background = System.Windows.Media.Brushes.Transparent,
                    AllowsTransparency = true, // 允許透明
                    Topmost = true,
                    Left = minX,
                ...
                var fadeInOut = new DoubleAnimation
                {
                    ...
                    From = 0.3,
                    To = 0,
                    Duration = TimeSpan.FromMilliseconds(time), // 快速變亮
                    AutoReverse = false,
                    EasingFunction = new QuadraticEase() { EasingMode = EasingMode.EaseIn } // 絲滑動畫
                };
